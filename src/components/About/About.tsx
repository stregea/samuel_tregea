...
export default function About() {
    ...
    const intro = (
        <p>
            Hi, I’m <Highlight>Sam Tregea</Highlight> <span className={styles.namePronunciation}>(tree-gay)</span>,
            a {getMyCurrentAge()} year old software engineer passionate about building scalable, user-focused solutions
            across the tech stack. With professional experience in both front-end and back-end development, I specialize
            in
    ...
    const hobbies = (
        <p>
            Outside of work, I enjoy training <Highlight>Brazilian Jiu Jitsu</Highlight>,
            playing <Highlight>Soccer</Highlight>, and spending time with my friends and family.
        </p>
    );
