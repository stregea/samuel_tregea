...
describe("ProjectCard", () => {
	 ...
	 */
	const validateProjectCard = (project: {title: string, description: string, sourceCode?: string, videoDemo?: string, documentation?: string, languages: string[], category: string}) => {
